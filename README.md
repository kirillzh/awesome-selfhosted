...
- [Actual](https://actualbudget.com/) - Actual is a super fast privacy-focused app for managing your finances. You own your data, and we will sync it across all devices with optional end-to-end encryption. ([Demo](https://app.actualbudget.com/budget), [Source Code](https://github.com/actualbudget/actual)) `MIT` `JavaScript`
